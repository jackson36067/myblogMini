...
public class User implements Serializable {
    ...
    public User(Long id, String openid, String name, String nickName, String phone, String sex, String idNumber, String avatar, Integer points, LocalDateTime createTime, Boolean isSignIn) {
        this.id = id;
        this.openid = openid;
        this.name = name;
